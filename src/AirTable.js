      ...
      return (
        <div className='card mb-4'>
                <div className='card-body'>
                    <h4 className='card-title'>Air Quality levels</h4>
                    <table className='table table-bordered'><thead><tr><th scope='col'>AQI Range</th><th scope='col'>Levels of Health Concern </th></tr></thead>
                    <tbody>
